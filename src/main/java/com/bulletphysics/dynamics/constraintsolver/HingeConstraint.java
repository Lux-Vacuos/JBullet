...
/**
 * Hinge constraint between two rigid bodies each with a pivot point that
 * descibes the axis location in local space. Axis defines the orientation of
 * the hinge axis.
 * 
 * @author jezek2
 */
public class HingeConstraint extends TypedConstraint {
	...
	public HingeConstraint(RigidBody rbA, RigidBody rbB, Vector3f pivotInA, Vector3f pivotInB, Vector3f axisInA,
			Vector3f axisInB) {
