...
*/
/**
 * Generic6DofConstraint between two rigidbodies each with a pivot point that
 * descibes the axis location in local space.
 * <p>
 * 
 * Generic6DofConstraint can leave any of the 6 degree of freedom "free" or
 * "locked". Currently this limit supports rotational motors.<br>
 * 
 * <ul>
 * <li>For linear limits, use {@link #setLinearUpperLimit},
 * {@link #setLinearLowerLimit}. You can set the parameters with the
 * {@link TranslationalLimitMotor} structure accsesible through the
 * {@link #getTranslationalLimitMotor} method. At this moment translational
 * motors are not supported. May be in the future.</li>
 * 
 * <li>For angular limits, use the {@link RotationalLimitMotor} structure for
 * configuring the limit. This is accessible through
 * {@link #getRotationalLimitMotor} method, this brings support for limit
...
public class Generic6DofConstraint extends TypedConstraint {
	...
	protected final Vector3f[] calculatedAxis/* [3] */ = new Vector3f[] { new Vector3f(), new Vector3f(),
			new Vector3f() };
	 ...
	 * 
	 * See also: Generic6DofConstraint.getCalculatedTransformA,
	 * Generic6DofConstraint.getCalculatedTransformB,
	...
	protected void buildLinearJacobian(/* JacobianEntry jacLinear */int jacLinear_index, Vector3f normalWorld,
			Vector3f pivotAInW, Vector3f pivotBInW) {
		...
		jacLinear[jacLinear_index].init(mat1, mat2, tmp1, tmp2, normalWorld, rbA.getInvInertiaDiagLocal(new Vector3f()),
	...
	protected void buildAngularJacobian(/* JacobianEntry jacAngular */int jacAngular_index, Vector3f jointAxisW) {
		...
		jacAng[jacAngular_index].init(jointAxisW, mat1, mat2, rbA.getInvInertiaDiagLocal(new Vector3f()),
	 ...
	 * corrected. Generic6DofConstraint.buildJacobian must be called previously.
	 */
	...
	/**
	 * Get the relative Euler angle. Generic6DofConstraint.buildJacobian must be
	 * called previously.
	 */
	 ...
	 * <p>
	 * See also: Generic6DofConstraint.getFrameOffsetA,
	 * Generic6DofConstraint.getFrameOffsetB,
	 * Generic6DofConstraint.calculateAngleInfo.
	 */
