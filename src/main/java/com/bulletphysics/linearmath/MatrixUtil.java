...
public class MatrixUtil {
	...
	/**
	 * Diagonalizes this matrix by the Jacobi method. rot stores the rotation from
	 * the coordinate system in which the matrix is diagonal to the original
	 ...
	 * by the sum of the absolute values of the diagonal, or when maxSteps have been
	 * executed. Note that this matrix is assumed to be symmetric.
	 */
