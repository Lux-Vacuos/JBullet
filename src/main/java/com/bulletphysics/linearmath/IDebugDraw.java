...
/**
 * IDebugDraw interface class allows hooking up a debug renderer to visually
 * debug simulations.
 * <p>
 * 
 * Typical use case: create a debug drawer object, and assign it to a
 * {@link CollisionWorld} or {@link DynamicsWorld} using setDebugDrawer and call
 * debugDrawWorld.
 * <p>
 * 
 * A class that implements the IDebugDraw interface has to implement the
...
public abstract class IDebugDraw {
	...
	public void drawTriangle(Vector3f v0, Vector3f v1, Vector3f v2, Vector3f n0, Vector3f n1, Vector3f n2,
