...
public class TransformUtil {
	...
	public static void integrateTransform(Transform curTrans, Vector3f linvel, Vector3f angvel, float timeStep,
		...
		if (fAngle < 0.001f) {
			...
			axis.scale(0.5f * timeStep - (timeStep * timeStep * timeStep) * (0.020833333333f) * fAngle * fAngle,
					angvel);
		} else {
	...
	public static void calculateVelocity(Transform transform0, Transform transform1, float timeStep, Vector3f linVel,
			Vector3f angVel) {
	...
	public static void calculateDiffAxisAngle(Transform transform0, Transform transform1, Vector3f axis,
			float[] angle) {
