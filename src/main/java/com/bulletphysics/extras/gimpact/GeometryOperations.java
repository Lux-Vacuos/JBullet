...
class GeometryOperations {
	 ...
	 * 
	 * @return -0 if the ray never intersects, -1 if the ray collides in front, -2
	 *         if the ray collides in back
	 */
	public static int line_plane_collision(Vector4f plane, Vector3f vDir, Vector3f vPoint, Vector3f pout,
			float[] tparam, float tmin, float tmax) {
	 ...
	 */
	public static void segment_collision(Vector3f vA1, Vector3f vA2, Vector3f vB1, Vector3f vB2, Vector3f vPointA,
			Vector3f vPointB) {
