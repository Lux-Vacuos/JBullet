...
/**
 * Stack-based object pool, see the example for usage. You must use the
 * {@link #returning} method for returning stack-allocated instance.
 * <p>
 * 
 * Example code:
 * 
...
public abstract class StackList<T> {
	...
	private final List<T> list = new GlueList<T>();
	private T returnObj;
	 ...
	 * essential that caller of method (that uses this method for returning
	 * instances) immediately copies it into own variable before any other usage.
	 * 
	 * @param obj
