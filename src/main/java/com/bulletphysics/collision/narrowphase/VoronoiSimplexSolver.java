 ...
 * algorithm from a 1-4 points simplex to the origin. Can be used with GJK, as
 * an alternative to Johnson distance algorithm.
 * 
 * @author jezek2
 */
public class VoronoiSimplexSolver implements SimplexSolverInterface {
	...
	protected final ObjectPool<SubSimplexClosestResult> subsimplexResultsPool = ObjectPool
			.get(SubSimplexClosestResult.class);
	...
	public boolean closestPtPointTriangle(Vector3f p, Vector3f a, Vector3f b, Vector3f c,
	...
	public boolean closestPtPointTetrahedron(Vector3f p, Vector3f a, Vector3f b, Vector3f c, Vector3f d,
