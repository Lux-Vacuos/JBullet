...
public class UnionFind {
	...
	private final List<Element> elements = new GlueList<>();

	/**
	 * This is a special operation, destroying the content of UnionFind. It sorts
	 * the elements, based on island id, in order to make it easy to iterate over
	 * islands.
	 */
