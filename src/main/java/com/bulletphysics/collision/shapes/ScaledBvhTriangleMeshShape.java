...
/**
 * The ScaledBvhTriangleMeshShape allows to instance a scaled version of an
 * existing {@link BvhTriangleMeshShape}. Note that each
 * {@link BvhTriangleMeshShape} still can have its own local scaling,
 * independent from this ScaledBvhTriangleMeshShape 'localScaling'.
 *
 * @author jezek2
 */
