...
/**
 * UniformScalingShape allows to re-use uniform scaled instances of
 * {@link ConvexShape} in a memory efficient way. Istead of using
 * {@link UniformScalingShape}, it is better to use the non-uniform
