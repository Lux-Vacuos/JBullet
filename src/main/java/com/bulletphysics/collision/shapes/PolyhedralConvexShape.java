...
/**
 * PolyhedralConvexShape is an internal interface class for polyhedral convex
 * shapes.
 * 
 * @author jezek2
 */
public abstract class PolyhedralConvexShape extends ConvexInternalShape {
	...
	// /** optional Hull is for optional Separating Axis Test Hull collision
	// detection, see Hull.cpp */
	...
	public void recalcLocalAabb() {
		...
		// VectorUtil.setCoord(localAabbMax, i, VectorUtil.getCoord(tmp, i) +
		// collisionMargin);
		// VectorUtil.setCoord(vec, i, -1f);
		// localGetSupportingVertex(vec, tmp);
		// VectorUtil.setCoord(localAabbMin, i, VectorUtil.getCoord(tmp, i) -
		// collisionMargin);
		// }
		// #endif
	}
