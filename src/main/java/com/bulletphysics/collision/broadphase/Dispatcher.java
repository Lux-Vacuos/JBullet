...
/**
 * Dispatcher abstract class can be used in combination with broadphase to
 * dispatch calculations for overlapping pairs. For example for pairwise
 * collision detection, calculating contact points stored in
 * {@link PersistentManifold} or user callbacks (game logic).
 * 
 * @author jezek2
 */
public abstract class Dispatcher {
	...
	public abstract void dispatchAllCollisionPairs(OverlappingPairCache pairCache, DispatcherInfo dispatchInfo,
