...
/**
 * BroadphaseProxy is the main class that can be used with the Bullet
 * broadphases. It stores collision shape type information, collision filter
 * information and a client object, typically a {@link CollisionObject} or
 * {@link RigidBody}.
 * 
 * @author jezek2
 */
public class BroadphaseProxy {
	...
	public int uniqueId; // uniqueId is introduced for paircache. could get rid of this, by calculating
							// the address offset etc.
