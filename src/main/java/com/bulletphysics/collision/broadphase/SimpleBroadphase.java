...
/**
 * SimpleBroadphase is just a unit-test for {@link AxisSweep3},
 * {@link AxisSweep3_32}, or {@link DbvtBroadphase}, so use those classes
 * instead. It is a brute force AABB culling broadphase based on O(n^2) AABB
 * checks.
 * 
 * @author jezek2
 */
public class SimpleBroadphase implements BroadphaseInterface {
	...
	private final List<SimpleBroadphaseProxy> handles = new GlueList<>();
